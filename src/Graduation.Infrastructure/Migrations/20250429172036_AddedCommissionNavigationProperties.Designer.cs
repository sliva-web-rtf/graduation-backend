...
namespace Graduation.Infrastructure.Migrations
{
    ...
    [Migration("20250429172036_AddedCommissionNavigationProperties")]
    partial class AddedCommissionNavigationProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Graduation.Domain.AcademicGroups.AcademicGroup", b =>
                {
                    b.HasOne("Graduation.Domain.AcademicPrograms.AcademicProgram", "AcademicProgram")
                        .WithMany()
            ...
            modelBuilder.Entity("Graduation.Domain.Commissions.CommissionExpert", b =>
                {
                    ...
                    b.HasOne("Graduation.Domain.Users.User", "Expert")
                        .WithMany()
            ...
            modelBuilder.Entity("Graduation.Domain.QualificationWorks.QualificationWork", b =>
                {
                    ...
                    b.HasOne("Graduation.Domain.Students.Student", "Student")
                        ...
                        .HasForeignKey("Graduation.Domain.QualificationWorks.QualificationWork", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Graduation.Domain.Users.User", "Supervisor")
                        .WithMany()
            ...
            modelBuilder.Entity("Graduation.Domain.Users.ApplicationUserRole", b =>
                {
                    b.HasOne("Graduation.Domain.Users.AppIdentityRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
