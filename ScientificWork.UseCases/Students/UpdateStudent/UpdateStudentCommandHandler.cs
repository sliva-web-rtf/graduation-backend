...
public class UpdateStudentCommandHandler : IRequestHandler<UpdateStudentCommand>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        student.ScientificAreaSubsections.Clear();
        selectedSubsections.ForEach(subsection => student.ScientificAreaSubsections.Add(subsection));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        student.ScientificInterests.Clear();
        selectedInterests.ForEach(interest => student.ScientificInterests.Add(interest));
    }
}
